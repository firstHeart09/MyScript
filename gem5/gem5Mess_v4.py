    ...
    def deal_inst(self, data, size):
        ...
        for line in data:
            ...
            if 'system.cpu.icache: access for ReadReq' in line and 'IF miss' in line:
                ...
                icache_cacheline_dict_hit[icache_address_] = ['', '']
                self.icache_cacheline[icache_address_] = [0, 0]  # icache信息
        ...
        for line in data:
            ...
            if ('moving from  to state' in line and 'system.cpu.icache:' in line):
                ...
                icache_cacheline_dict_hit[icache_loaded_cache][0] = '1->2'
                self.icache_cacheline[icache_loaded_cache][0] += 1
                continue
            # 判断是不是指令
...
if __name__ == '__main__':
    ...
    # debug = Gem5DebugMess('./input/debug_dynamic.txt', '0x3f', 'dynamic', './m5out', '1', 'yes')
    debug.process()
